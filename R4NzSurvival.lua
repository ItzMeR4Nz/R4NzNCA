-- ============================================
-- R4NzDev UI - 5 TABS (ANDROID TOUCH FIXED)
-- ============================================
...
local scriptKey = "R4NzDev_UI_Fixed"
...
-- ============================================================
-- DRAG WINDOW (sama seperti kode Anda)
-- ============================================================
...
-- ============================================================
-- RESIZE WINDOW (sama seperti kode Anda)
-- ============================================================
...
-- ============================================================
-- UPDATE RESIZE HANDLE POSITION (sama seperti kode Anda)
-- ============================================================
RunService.RenderStepped:Connect(function()
...
-- INIT
-- ============================================================
print("✅ R4NzDev UI berhasil dimuat!")
