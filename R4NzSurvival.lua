...
-- ============================================
-- FLOATING BUTTON FOR AUTO PICKUP
-- ============================================
local function createFloatingButton()
    ...
    button.Position = UDim2.new(0.85, 0, 0.5, 0) -- Posisi awal (kanan tengah)
    button.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
    button.BackgroundTransparency = 0.1
    button.BorderSizePixel = 0
    button.Parent = screenGui
    
    -- Corner (bikin jadi bulat)
    ...
    icon.Text = "⏏" -- Simbol auto pickup (Eject/Upload)
    ...
    -- Status label (ON/OFF kecil di bawah)
    ...
    button.MouseEnter:Connect(function()
        ...
        hoverTween:Play()
        local scaleTween = TweenService:Create(button, tweenInfo, {Size = UDim2.new(0, 65, 0, 65)})
        scaleTween:Play()
    end)
    ...
    button.MouseLeave:Connect(function()
        ...
        leaveTween:Play()
        local scaleTween = TweenService:Create(button, tweenInfo, {Size = UDim2.new(0, 60, 0, 60)})
        scaleTween:Play()
    end)
    
    -- Fungsi drag (pindah tombol)
...
local function stopAutoPickup()
    ...
    -- Update floating button jika ada
